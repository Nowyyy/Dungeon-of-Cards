...
*/
typedef enum{move=0, selection, change_salle, footsteps, gameOverFrame, death, collect, chest, enterFight, animDeath, punch, heal, sword, rock, potion, divine, bouclier, poison, bdf}t_sons;
